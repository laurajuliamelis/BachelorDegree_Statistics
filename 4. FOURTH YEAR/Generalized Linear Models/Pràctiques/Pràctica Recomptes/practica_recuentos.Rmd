...
A modo de repaso, y para entender mejor el presente apartado, se procede a comentar brevemente la distribución de Poisson y la aplicación en el caso que nos concierene. 
...
Se procede a realizar el método stepwise del modelo más completo (con todas las variables e interacciones):
...
m3$dev
m3$df.residual
1 - pchisq(m3$dev,m3$df.residual) # Test devianza
```
